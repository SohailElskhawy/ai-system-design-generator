    ...
    <div className="overflow-hidden rounded-xl border border-zinc-800 bg-zinc-950/40 transition-all hover:border-zinc-800/80">
      ...
      {!isCollapsed && (
        <div className="p-5 md:p-6 space-y-6">
          ...
          {/* Tab Selector */}
          <div className="flex border-b border-zinc-900 pb-1 gap-6 text-xs font-mono">
            <button
              onClick={() => setActiveTab("interactive")}
              className={`pb-2 border-b-2 transition-all cursor-pointer focus:outline-none ${
          ...
          {activeTab === "interactive" ? (
            <>
              ...
              <div className="rounded-xl border border-zinc-900 bg-zinc-950 p-6 flex flex-col items-center justify-center gap-6 overflow-x-auto min-w-full">
                <span className="text-[10px] font-bold uppercase tracking-wider text-zinc-650 font-mono">
                    ...
                    return (
                      <React.Fragment key={node.id}>
                        <button
                          ...
                          className={`relative flex flex-col items-center gap-2 rounded-lg border p-3 min-w-30 transition-all cursor-pointer focus:outline-none ${
                            isSelected
            ...
            architecture.mermaidDiagram && (
              <div className="space-y-4 animate-fadeIn">
                ...
                <div className="rounded-lg border border-zinc-900 bg-zinc-950 p-4 font-mono text-[10px] text-zinc-500">
                  ...
                  <pre className="text-zinc-500 overflow-x-auto leading-normal whitespace-pre-wrap">{architecture.mermaidDiagram}</pre>
                </div>
              </div>
            )
          )}
